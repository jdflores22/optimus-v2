...
export function ManifestBulkImportNoasPage() {
  ...
  return (
    <WorkflowPage
      ...
      title="Bulk Import NOAs"
      subtitle="Dedicated NOA import surface, modeled after the V1 bulk import page with template guidance and a focused upload action."
      actions={
      ...
      stats={[
        { label: 'Mode', value: 'Bulk NOA import', hint: 'CSV task surface', tone: 'primary' },
    ...
    >
      ...
      <Box sx={{ display: 'grid', gap: 3, gridTemplateColumns: { xs: '1fr', lg: 'minmax(0, 1.2fr) minmax(280px, 360px)' } }}>
        <WorkflowSection title="Upload NOA file" subtitle="Upload a CSV containing the rows you want to bring into the workflow.">
          <Stack spacing={2}>
            <Button
              variant="contained"
              component="label"
        ...
        <Stack spacing={3}>
          <WorkflowSection
            ...
            actions={
              <Button
                ...
                onClick={() =>
                  downloadTemplate(
                    'noa-import-template.csv',
                    'ManifestNumber,Vessel,Voyage,ArrivalDate,BlNumber\nMF-100001,MV Optimus,V001,2026-08-06,BL-100001\n',
                  )
                }
              >
                Download template
          ...
          <WorkflowSection title="How to use" subtitle="Operational guidance carried over from the V1 import flow.">
            <Stack spacing={1}>
              <Typography variant="body2" color="text.secondary">
                1. Download the template and fill one shipment per row.
              </Typography>
              <Typography variant="body2" color="text.secondary">
